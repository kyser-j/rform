import type { Button, Checkbox, Dropdown, Input, NextButton, PreviousButton, RadioButton, Text, TextArea } from '@/lib/types/BuiltInComponents';
...
import PreviousPageButtonComponent from './built-in/component/PreviousPageButtonComponent';
...
const ComponentRenderer = observer(({ component }: Props) => {
  switch (component.formComponentType) {
    ...
    case 'previousbutton': {
      return <PreviousPageButtonComponent component={component as PreviousButton} />;
    }
    case 'checkbox': {
